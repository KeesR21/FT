...
export function IconShirt(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...iconProps(p)}>
      <path d="M16 3l3 3 3 1-3 4-2-1v11a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2V10l-2 1-3-4 3-1 3-3" />
      <path d="M9 3l3 2 3-2" />
    </svg>
  );
}

export function IconShoppingBag(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...iconProps(p)}>
...
export function IconCurrency(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...iconProps(p)}>
...
export function IconUserPlus(p: SVGProps<SVGSVGElement>) {
  return (
    <svg {...iconProps(p)}>
